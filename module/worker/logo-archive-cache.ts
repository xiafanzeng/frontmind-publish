import { normalizePublisherLogo, PUBLISHER_LOGO_CONTENT_TYPES } from "../server/domain/index.js";
import type { PrivateObjectStore, PublisherWorkerDependencies } from "./ports.js";
...
export class PublisherLogoArchiveCache {
  ...
  constructor(
    ...
    private readonly fetcher: NonNullable<PublisherWorkerDependencies["mediaFetcher"]>,
