...
export type PublisherHttpDependencies = {
  config: { PUBLISHER_FEATURE_ENABLED: boolean; PUBLISHER_PUBLIC_ASSETS_ENABLED: boolean; KOL_WEBHOOK_ENABLED: boolean; KOL_WEBHOOK_CONFIGURED: boolean; KOL_WEBHOOK_MAX_BYTES: number };
  ...
  app.post(
    ...
    (request, response, next) => {
      if (
        ...
        !dependencies.config.KOL_WEBHOOK_CONFIGURED ||
