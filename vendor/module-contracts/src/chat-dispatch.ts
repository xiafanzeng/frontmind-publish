...
import { generalAgentModelProfileSchema } from "./agent-profile.js";
import {
...
export const generalChatDispatchSchema = z
  ...
  .superRefine((value, context) => {
    ...
    // A continuation may freeze a new effort choice. Only the XTY provider
    // applies it; existing business and Zhipu tasks retain their runtime.
  });
