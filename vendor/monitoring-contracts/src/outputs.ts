...
export const reasoningSupportSchema = z.enum([
  "supported",
  "unsupported",
  "unknown",
]);
...
export const platformOutputSchema = z.object({
  ...
  reasoningSupport: reasoningSupportSchema,
...
const monitorQuestionOutputSchema = z.object({
  ...
  categorySnapshot: monitoringQuestionCategorySchema.nullable().default(null),
});
