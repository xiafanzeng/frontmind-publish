...
interface MarkdownRendererProps {
  ...
  /** Archive-relative image files are displayed separately via approved resources. */
  hideRelativeImages?: boolean;
  onArtifactDownload?: (href: string) => void | Promise<void>;
}
...
function MarkdownRendererInner({
  ...
  const linkComponents = generalChatLinks
    ? {
        ...components,
    ...
    : components;
  const rendererComponents: Components = hideRelativeImages
    ? {
        ...linkComponents,
    ...
    <MarkdownCopyContext.Provider value={allowCopy}>
      <MarkdownErrorBoundary fallbackContent={content}>
        <MarkdownRendererInner
          ...
          hideRelativeImages={hideRelativeImages}
